...
public class TimeUtils {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String nowYearMonth = TimeUtils.parseTime(now2,TimeUtils.TimeFormat.SHORT_YEAR_MONTH_PATTERN_LINE);
        ...
        //将Date转换为String
        System.out.println(TimeUtils.convertDateToString(new Date(),TimeUtils.TimeFormat.SHORT_DATE_PATTERN_LINE));

        //将String转换为Date
        Date date = TimeUtils.convertStringToDate("2018-03-27 14:52:57",TimeUtils.TimeFormat.LONG_DATE_PATTERN_LINE);
        System.out.println(date.toString());

        //将毫秒数转化为String
        System.out.println(TimeUtils.convertMillisToString(System.currentTimeMillis(),TimeUtils.TimeFormat.LONG_DATE_PATTERN_LINE));

        //将String转化为毫秒数
        long millis2 = TimeUtils.convertStringToMillis("2018-03-27 14:52:57",TimeUtils.TimeFormat.LONG_DATE_PATTERN_LINE);
